...
export default {
  translations: {
    ...
    section: {
      lastReleases: `Ultimos lançamentos`,
      photoGallery: `Fotos`,
      contact: `Contato`,
    },
    gallery: {
      downloadPressKit: `Baixar Press Kit`,
    },
    contactForm: {
      generalInquiries: `Assuntos gerais`,
      booking: `Booking`,
      ...
      errorSubject: `Por favor insira um assunto`,
      errorMessage: `Por favor, digite uma mensagem`,
      send: `Enviar`,
      limitName: `Por favor, use 30 caracteres ou menos`,
      limitSubject: `Por favor, use 30 caracteres ou menos`,
    },
    about: {
